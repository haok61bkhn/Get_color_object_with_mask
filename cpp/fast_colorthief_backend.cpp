...
std::vector<color_t> get_palette_mask(py::array_t<uint8_t,  py::array::c_style> image,py::array_t<uint8_t,  py::array::c_style>  mask, int color_count, int quality) {
